...
class About(models.Model):  
    ...
    objective6 = models.TextField(default = '',blank=True)
    objective7 = models.TextField(default = '',blank=True) 
    objective8 = models.TextField(default = '',blank=True) 
    objective9 = models.TextField(default = '',blank=True) 
    objective10 = models.TextField(default = '',blank=True)  
    ...
    wash = models.CharField(max_length=100,default = '',blank=True  )
